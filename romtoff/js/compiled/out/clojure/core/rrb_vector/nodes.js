...
var slc = (rngs[(32)]);
var and__18104__auto__ = (slc === (32));
if(and__18104__auto__){
var or__18116__auto__ = (shift === (5));
if(or__18116__auto__){
return or__18116__auto__;
} else {
var G__25076 = (root.arr[(slc - (1))]);
var G__25077 = (shift - (5));
var G__25078 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__25076;
shift = G__25077;
cnt = G__25078;
continue;
...
var rngs_25087 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_25088 = (rngs_25087[(0)]);
var new_rngs_25089 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_25090 = (rngs_25087[(32)]);
cljs.core.array_copy.call(null,rngs_25087,(1),new_rngs_25089,(0),(lim_25090 - (1)));

var i_25091 = (0);
while(true){
if((i_25091 < lim_25090)){
(new_rngs_25089[i_25091] = ((new_rngs_25089[i_25091]) - rng0_25088));
...
(new_rngs_25089[(32)] = ((rngs_25087[(32)]) - (1)));

(new_rngs_25089[((rngs_25087[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_25089);
} else {
}
...
while(true){
if((i_25093 <= li)){
(new_rngs[i_25093] = ((new_rngs[(i_25093 - (1))]) + step));

var G__25094 = (i_25093 + (1));
i_25093 = G__25094;
continue;
} else {
}
...
while(true){
if((i_25095 <= li)){
(new_rngs[i_25095] = ((rngs[i_25095]) - d));

var G__25096 = (i_25095 + (1));
i_25095 = G__25096;
continue;
} else {
}
...
while(true){
if((j_25097 <= i)){
(rngs[j_25097] = r_25098);

var G__25099 = (j_25097 + (1));
var G__25100 = (r_25098 + step);
j_25097 = G__25099;
r_25098 = G__25100;
continue;
} else {
...
var rngs = ((!(reg_QMARK_))?(function (){var G__25102 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__25102[(0)] = node.arr.length);
...
var arr_25103__$1 = arr;
var shift_25104__$1 = shift;
while(true){
if((shift_25104__$1 === (5))){
if(!(reg_QMARK_)){
(arr_25103__$1[(32)] = rngs);
} else {
}

(arr_25103__$1[(0)] = node);
} else {
var a_25105 = (new Array(len));
var e_25106 = cljs.core.__GT_VectorNode.call(null,null,a_25105);
(arr_25103__$1[(0)] = e_25106);
...
var G__25107 = a_25105;
var G__25108 = (shift_25104__$1 - (5));
arr_25103__$1 = G__25107;
shift_25104__$1 = G__25108;
continue;
}
break;
}
...
var reg_QMARK_ = (function (){var and__18104__auto__ = clojure.core.rrb_vector.nodes.regular_QMARK_.call(null,node);
...
//# sourceMappingURL=nodes.js.map?rel=1431292025242